package com.example.ikhsanahoteltv.kiosk
...
import com.example.ikhsanahoteltv.SplashActivity
...
class KioskWatchdogService : Service() {
    ...
    companion object {
        ...
        const val ACTION_CHECK_NOW = "com.example.ikhsanahoteltv.kiosk.CHECK_NOW"
        const val ACTION_STOP = "com.example.ikhsanahoteltv.kiosk.STOP"
