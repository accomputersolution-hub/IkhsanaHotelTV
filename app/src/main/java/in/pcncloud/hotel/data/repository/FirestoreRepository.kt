    ...
    private fun parseHotelBranding(hotelId: String, data: Map<String, Any?>): HotelBranding {
        ...
        return HotelBranding(
            ...
            bgWallpaperUrl = firstNonBlank(
                ...
                asTrimmedString(branding["bgWallpaperDay"]),
                asTrimmedString(branding["bg_wallpaper_day"]),
                ...
                asTrimmedString(data["bgWallpaperDay"]),
                asTrimmedString(data["bg_wallpaper_day"]),
