 ...
 *
 * Always opens [SplashActivity] so corporate WireGuard can run
 * [android.net.VpnService.prepare] from a visible Activity before Main/Pairing.
 *
...
class BootReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        // Splash owns VPN consent + overlay gate, then routes to Main or Pairing.
        val target = SplashActivity::class.java
