  ...
  return (
    <section id="contact" className="section-pad">
      <div className="glass-strong relative overflow-hidden rounded-[2rem] p-8 sm:p-12">
        <div className="pointer-events-none absolute -right-20 -top-20 h-64 w-64 rounded-full bg-neon-blue/25 blur-[90px]" />
        <div className="pointer-events-none absolute -bottom-24 -left-16 h-64 w-64 rounded-full bg-neon-purple/20 blur-[90px]" />
        ...
        <div className="relative grid gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="mailto:hello@pcncloud.in?subject=PCN%20Cloud%20consultation" className="btn-primary">
          ...
          <Reveal delay={0.12}>
            <div className="space-y-4 rounded-3xl border border-white/10 bg-ink-900/60 p-6">
