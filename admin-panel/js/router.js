...
export function getRoute() {
  ...
  if (['pms', 'room-features', 'kds', 'menu', 'messaging', 'housekeeping', 'agenda', 'concierge', 'analytics', 'billing', 'staff'].includes(mod)) {
    return '/pms';
  }
  return path;
}
...
export function getModuleFromRoute() {
  ...
  if (['pms', 'room-features', 'kds', 'menu', 'messaging', 'housekeeping', 'agenda', 'concierge', 'analytics', 'billing', 'staff'].includes(parts[0])) {
    return parts[0];
  }
