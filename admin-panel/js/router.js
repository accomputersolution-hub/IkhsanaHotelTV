...
export function getRoute() {
  ...
  if (['pms', 'kds', 'menu', 'messaging', 'housekeeping', 'agenda', 'concierge', 'analytics', 'billing', 'staff'].includes(mod)) {
    return '/pms';
  }
  return path;
}
...
export function getModuleFromRoute() {
  ...
  if (['pms', 'kds', 'menu', 'messaging', 'housekeeping', 'agenda', 'concierge', 'analytics', 'billing', 'staff'].includes(parts[0])) {
    return parts[0];
  }
